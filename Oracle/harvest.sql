...
CREATE TABLE harvest(
	...
	OBSCLIN_START_DATE_MGMT varchar(2) NULL,
    OBSCLIN_STOP_DATE_MGMT varchar(2) NULL,
	OBSGEN_DATE_MGMT varchar(2) NULL,
    ADDRESS_PERIOD_START_MGMT varchar(2) NULL,
    ADDRESS_PERIOD_END_MGMT varchar(2) NULL,
    VX_RECORD_DATE_MGMT varchar(2) NULL,
    VX_ADMIN_DATE_MGMT varchar(2) NULL,
    VX_EXP_DATE_MGMT varchar(2) NULL,
    REFRESH_HASH_TOKEN_DATE date NULL,
    --REFRESH_LDS_ADDRESS_HISTORY_DATE date NULL,
    --REFRESH_IMMUNIZATION_DATE date NULL,
...
INSERT INTO harvest(NETWORKID, NETWORK_NAME, TOKEN_ENCRYPTION_KEY, DATAMARTID, DATAMART_NAME, DATAMART_PLATFORM, CDM_VERSION, DATAMART_CLAIMS, DATAMART_EHR,
    BIRTH_DATE_MGMT, ENR_START_DATE_MGMT, ENR_END_DATE_MGMT, ADMIT_DATE_MGMT, DISCHARGE_DATE_MGMT, DX_DATE_MGMT, PX_DATE_MGMT, RX_ORDER_DATE_MGMT,
    ...
    OBSCLIN_START_DATE_MGMT, OBSCLIN_STOP_DATE_MGMT, OBSGEN_DATE_MGMT, ADDRESS_PERIOD_START_MGMT, ADDRESS_PERIOD_END_MGMT,VX_RECORD_DATE_MGMT,
	...
	select '&&network_id', '&&network_name', getEncryptionKey()  ,getDataMartID(), getDataMartName(), getDataMartPlatform(), 4.1, hl.DATAMART_CLAIMS, hl.DATAMART_EHR,
	...
	hl.DEATH_DATE_MGMT, hl.MEDADMIN_START_DATE_MGMT, hl.MEDADMIN_STOP_DATE_MGMT, hl.OBSCLIN_START_DATE_MGMT, h1.OBSCLIN_STOP_DATE_MGMT ,hl.OBSGEN_DATE_MGMT,
